...
export default function Navbar({ user, logout, setView, currentView }) {
  return (
    <nav className="bg-white border-b-[2.5px] border-[#362F4F]/10 sticky top-0 z-[1000] px-6 h-20 flex items-center font-sans">
      <div className="max-w-7xl mx-auto w-full flex items-center justify-between">
        ...
        {/* 2. NAVIGATION: Hover States Restored */}
        <div className="flex items-center gap-5">
          ...
          {/* 3. USER HUB: Hover Glow Added */}
          <div className="flex items-center gap-4 bg-[#362F4F] pl-4 pr-1 py-1 rounded-lg border-[2px] border-[#362F4F] shadow-sm group hover:shadow-[0_0_15px_rgba(54,47,79,0.2)] transition-all cursor-pointer">
